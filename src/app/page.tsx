  ...
  return (
    <div className='mt-4 flex flex-col gap-4'>
      ...
      <div className="flex items-center justify-between">
        ...
        {/* animated button */}
        <Link href={`${!user ? "/login" : "write"}`} className='hidden md:block relative cursor-pointer'>
          <svg
            viewBox="0 0 200 200"
            width="200"
            height="200"
            className="text-lg tracking-widest animate-spin animatedButton cursor-pointer"
          >
            <path
              id="circlePath"
              fill="none"
